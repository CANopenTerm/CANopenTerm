...
void completion_callback(completions_t* cenv, const char* prefix)
{
    ...
    {
        os_completion_add(cenv, "1", "1", "CiA 301 Application layer and communication");
        os_completion_add(cenv, "2", "2", "CiA 302 Programmable CANopen Devices");
        os_completion_add(cenv, "3", "3", "CiA 401 I/O devices");
        os_completion_add(cenv, "4", "4", "CiA 402 Drives and motion control");
        os_completion_add(cenv, "5", "5", "CiA 404 Measurement Devices and Closed Loop Controllers");
        os_completion_add(cenv, "6", "6", "CiA 406 Encoders");
        os_completion_add(cenv, "7", "7", "CiA 408 Fluid Power Technology");
        os_completion_add(cenv, "8", "8", "CiA 410 Inclinometer");
        os_completion_add(cenv, "9", "9", "CiA 413 Truck Gateways");
        os_completion_add(cenv, "10", "10", "CiA 415 Road construction machinery");
        os_completion_add(cenv, "11", "11", "CiA 416 Building door control");
        os_completion_add(cenv, "12", "12", "CiA 417 Lift control systems");
        os_completion_add(cenv, "13", "13", "CiA 418 Battery modules");
        os_completion_add(cenv, "14", "14", "CiA 419 Battery chargers");
