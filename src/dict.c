...
static const dict_entry_t dictionary[] =
{
    ...
    { 0x0022, 0x0000, 0x00, 0x00, "SDO parameter record specification, COB-ID client -> server" },
    { 0x0022, 0x0000, 0x00, 0x00, "SDO parameter record specification, COB-ID server -> client" },
    { 0x0022, 0x0000, 0x00, 0x00, "SDO parameter record specification, Node-ID of SDO’s client resp. server" },
